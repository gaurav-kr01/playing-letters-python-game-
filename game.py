...
pygame.display.set_caption('GAURAV PROJECT - PLAYING LETTER')
background = pygame.image.load('"E:\01\FINAL GAME\front.jpg"')
...
def game_front_screen():
    ...
    if not game_over :
        ...
        draw_text(gameDisplay, "START", 54, WIDTH / 2, 500)
    pygame.display.flip()
    waiting = True
    while waiting:
...
while True:
    ...
    character = pygame.image.load('fox.png')
